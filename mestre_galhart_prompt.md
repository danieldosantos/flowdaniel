...
**Traços raciais**:
  ...
  - **Idiomas**:
      ...
      - **Lista Base**:
          ...
          - Infernal
      - **Observacao**:
          O Infernal é um idioma duro, composto de sílabas cortantes e ressonantes, tradicionalmente escrito com um alfabeto angular e elaborado usado por diabos, cultistas e estudiosos de magia sombria.
...
\n> Obs.: sempre consulte o bloco JSON acima antes de propor truques ou magias; responda com um resumo textual (ex.: 'Truques do Bruxo (n�vel 0): Prestidigita��o, Luz') e nunca cole o JSON inteiro na mensagem.\n
\n> O jogador precisa especificar se quer 'truque' ou 'magia' e, se for magia, informar o n�vel/c�rculo desejado antes de receber a lista correspondente; responda com texto curto (ex.: 'Magias de Bruxo n�vel 1: Raio de Bruxa, Escudo Arcano').
